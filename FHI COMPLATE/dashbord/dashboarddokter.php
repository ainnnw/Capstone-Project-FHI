...
<!--user-->
  ...
  <div class="row">
    ...
    <div class="card">
  <div class="card-body">
  <i class="bi bi-vimeo "> FHI Data Dokter</i>
    ...
    <div class="row justify-content-center shadow-lg p-3 mb-5 bg-body rounded">
      ...
      <div class="card">
              <div class="card-header">
                ...
                <a class="dropdown-item " href="tambahdokter.php"><h5><i class="bi bi-calendar2-plus"></i></i> ADD DOKTER</h5> </a>
              ...
              <div class="card-body">
                <table class="table table-bordered table-hover" id="myTable3" >
                  ...
                  <tr class="text-center my-3" fs-5>
                    <th>id</th>
                    <th>Nama</th>
                    <th>KategoriSepesailis</th>
                    <th class="px-3">TempatPraktik</th>
                    <th class="px-5">Pelayanan</th>
                    <th class="px-5">NoHP</th>
		...
		while($d = mysqli_fetch_array($data)){
			?>
                  ...
                  <tr>
                    ...
                    <td><?php echo $d['spesailis']; ?></td>
                    <td><?php echo $d['tempatpraktik']; ?></td>
                    <td><?php echo $d['pelayanan']; ?></td>
                    <td><?php echo $d['nohp']; ?></td>
                  
                  <div class="aksi">
                  <td> 
                  <a href="../proses/hapusdokter.php?id=<?php echo $d['id']; ?>" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                  <a href ="ubahdokter.php?id=<?php echo $d['id']; ?>"  class="btn btn-warning"><i class="fas fa-cog"></i></a>
                  </td>
                  <div>
                  </tr>
                  </tfoot>
