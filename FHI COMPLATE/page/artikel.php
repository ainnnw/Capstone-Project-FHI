...
<nav class="navbar">
  ...
  <main>
    ...
    <div class="container kategori">
      <h1>ALL Blog </h1>
      <a class="btn btn-success" href="kategori.php?kategori=umum" role="">Terbaru</a>
    ...
    <div class="row ">
     <?php 
        ...
        while($d = mysqli_fetch_array($data)){
          ...
          if (isset($_GET['cari'])) {
            $cari = $_GET['cari'];
            $data = mysqli_query($koneksi, "select * from blog where judul like '%" . $cari . "%'");
          }
          else {
            $data = mysqli_query($koneksi, "select * from blog");
          }
        ...
        <div class=" card col-lg-3 mx-2 my-2">
          ...
          <div class="card-body">
            <a  href="../page/baca-artikel.php?id=<?php echo $d['id']; ?>"><?php echo $d['judul']?></a>
            <p class="card-text"><?php echo $d['isipendek']?></p>
            <p class="tanggal-terbit"><?php echo $d['tanggalPost']?></p>
          </div>
        </div>
       <?php
        }
