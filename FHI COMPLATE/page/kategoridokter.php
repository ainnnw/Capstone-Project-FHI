...
<nav class="navbar">
  ...
  <main>
    ...
    <?php
    include '../koneksi.php';
    if (isset($_GET['spesailis'])) {
      $kategorii = $_GET['spesailis'];
      $data = mysqli_query($koneksi, "select * from dokter where spesailis='$kategorii'");
      $result = mysqli_fetch_array($data);
    ?>
      <h1>KATEGORI <?php echo $result['spesailis'];?></h1>
    ...
    if (isset($_GET['spesailis'])) {
      ...
      while ($d = mysqli_fetch_array($data)){
        ...
        <div class="feature-icon ">
          ...
          <h3 style="font-size:20px;"><?php echo $d['NamaDokter'];?></h2>
             <h3 style="text-align: left; font-size: 15px;background-color: aquamarine;padding: 5px; border-radius: 5%;"><?php echo $d['spesailis'];?></h3>
             <p style="font-size: 15px;"><i class="bi bi-hospital fs-6"></i> <?php echo $d['tempatpraktik'];?></p>
             <p id="hari-praktek " style="font-size: 15px;margin-top:-10px;"><i class="bi bi-calendar-check   mt--2"></i> <?php echo $d['jadwalpraktik'];?></p>
